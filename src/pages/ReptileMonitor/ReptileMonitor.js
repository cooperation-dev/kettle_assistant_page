...
import {loadData, loadEcharts, showRange} from '../../redux/actions/reptile_monitor';
                ...
                <Row gutter={16} style={{padding: "14px"}}>
                    <Col className="gutter-box" span={24}>
                        <Card>
                            ...
                            <Row>
                                <Col span={18}>
                                    <Bar data={this.props.reptileMonitor.options}></Bar>
                                </Col>
                                <Col span={6}>
                                    <List
                                        header={this.props.reptileMonitor.rangeData.title}
                                        dataSource = {this.props.reptileMonitor.rangeData.list.map(ele => {
                                            return (
                                                <Row style={{width: "100%"}}>
...
// export default reptileMonitor
// export default connect((state) => ({reptileMonitor: state.reptileMonitor}), {loadData})(reptileMonitor)
export default connect((state) => ({
    reptileMonitor: state.reptileMonitor
}), {loadData, loadEcharts, showRange})(reptileMonitor)